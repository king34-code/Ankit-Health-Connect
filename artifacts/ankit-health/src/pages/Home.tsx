        ...
        <div className="container mx-auto px-4">
          <RevealSection>
            <motion.div variants={fadeUp} custom={0} className="text-center mb-14">
              <p className="text-accent font-medium text-sm uppercase tracking-widest mb-3">Why Sample Health</p>
          ...
          <RevealSection>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <TestimonialCard
                delay={1}
                rating={5}
                quote="I booked a cardiologist appointment within minutes. No more calling up clinics and being put on hold for 20 minutes. Sample Health is a game changer."
                name="Priya S."
      ...
      <section className="py-20 bg-primary text-white text-center">
        <RevealSection className="container mx-auto px-4">
          <motion.div variants={fadeUp} custom={0}>
            ...
            <p className="text-white/70 text-lg mb-8 max-w-xl mx-auto">Join thousands of patients who manage their health with Sample Health.</p>
            <Button
              size="lg"
      ...
      <footer className="bg-primary/95 text-white/70 py-12 border-t border-white/10">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="font-serif font-bold text-white text-lg">Sample Health</span>
              </div>
          ...
          <div className="border-t border-white/10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-white/40">
            <span>© {new Date().getFullYear()} Sample Health. All rights reserved.</span>
